<?php
//this is basic class for loading page/layout data/templates from json or csv photos
//usually you have a Controller which grabs needed data from database using models, etc and passes it onto the view/template photos
class Page {
 ...
 /**
  ...
  for a page we load all photos in the related directory
