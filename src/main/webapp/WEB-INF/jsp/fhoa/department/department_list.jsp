...
<body class="no-skin">
							...
							<form action="department/list.do" method="post" name="Form"
								...
								<table style="margin-top: 5px;">
									<tr>
										...
										<td> 
											<button type="button" class="btn btn-info">房屋办件分析</button>
										</td>
										<c:if test="${QX.cha == 1 }">
	...
	<script type="text/javascript">
		...
		function edit(Id){
			 ...
			 diag.Height = 550;
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){parent.location.href="<%=basePath%>department/listAllDepartment.do?DEPARTMENT_ID=${DEPARTMENT_ID}&dnowPage=${page.currentPage}";
				}
				diag.close();
			};
			diag.show();
