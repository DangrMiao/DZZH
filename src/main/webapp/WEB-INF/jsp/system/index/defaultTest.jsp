		...
		<form id="search-form-group-condition" class="form-inline search-form" role="form">
			<div class="well" style="margin-top: -15px;height:56px;">
		 	   ...
		 	   <div style="padding-left: 10px;" class="input-group">
			       ...
			       <button id="image-group-btn" style="margin-left: 80px;" type="button" class="btn btn-sm btn-success form-group" onClick="YingXiang()">
						影像
				   </button> 
				    <button id="map-group-btn" style="margin-left: 80px;" type="button" class="btn btn-sm btn-success form-group" onClick="Ditu()">
						地图
				   </button>
...
<%-- 		function toExcel(){
        ...
        function YingXiang() { 
        	map = new TMap('mapDiv'); 
            map.centerAndZoom(new TLngLat(118.881543, 28.666191),10); 
