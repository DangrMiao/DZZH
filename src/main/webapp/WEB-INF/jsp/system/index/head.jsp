		<div id="navbar" class="navbar navbar-default" style="background:#0074A6">
 ...
 -->
						...
						<!-- #section:basics/navbar.user_menu -->
						 <li class="light-blue">
							<a data-toggle="dropdown" style="background:#0074A6;margin-top:10px" class="dropdown-toggle" href="#">
