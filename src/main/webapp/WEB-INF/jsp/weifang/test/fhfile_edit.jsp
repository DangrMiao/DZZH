					...
					<form action="" name="Form" id="Form" method="post"  >
						...
						<%-- <table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td>
									<input type="file" name="uploadify1" id="uploadify1"  multiple="true"/>
						...
						<input class="btn btn-mini btn-primary" id="fileupload" name="fileupload" type="file"  multiple>
		...
		$(document).ready(function(){
			...
			$("#uploadify1").uploadify({
			 'debug':'true',//开发者模式
                ...
                'swf':"<%=basePath%>plugins/uploadify/uploadify.swf",//动态控件
				<%-- 'swf'       :"<%=basePath%>plugins/uploadify/uploadify.swf",  //引入uploadify.swf   --%>
