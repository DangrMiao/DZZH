 ...
 * logic from template photos. In fact, it is not even possible to embed logic in the template.
 *
...
class Mustache_Engine
{
     ...
     *
     *         // Override default permissions for cache photos. Defaults to using the system-defined umask. It is
