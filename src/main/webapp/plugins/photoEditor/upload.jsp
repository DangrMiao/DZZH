<%@page import="com.weidekeji.common.util.Property"%>
...
if ( contentType.indexOf("multipart/form-data") >= 0 )
{
	...
	while( fileItems.hasNext() )
	{
		...
		{
			String virtualPath = "jsp_avatar" + avatarNumber + "_" + fileName + ".jpg";
			...
			if( isSourcePic )
			{
				...
				result.sourceUrl = virtualPath = String.format("jsp_source_%s.%s", fileName, sourceExtendName);
			}
			...
			outputStream = new BufferedOutputStream(new FileOutputStream(path + virtualPath));
